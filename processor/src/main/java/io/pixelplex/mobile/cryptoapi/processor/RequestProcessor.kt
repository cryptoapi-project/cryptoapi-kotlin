package io.pixelplex.mobile.cryptoapi.processor
...
class RequestProcessor : KotlinAbstractProcessor(), KotlinMetadataUtils {
    ...
    private fun generateCode(className: String, elements: List<ExecutableElement>) {
        ...
        if (elements.isNotEmpty()) {
            ...
            val fileSpec = FileSpec.builder(pack, className)
                ...
                .addImport("io.pixelplex.mobile.cryptoapi.model.generation", "QueryParameter", "QueryType", "RequestParameter")
            ...
            fileSpec.addImport("io.pixelplex.mobile.cryptoapi.support", "fromJson")
            fileSpec.addImport("io.pixelplex.mobile.cryptoapi.model.exception", "ApiException")
            fileSpec.addImport("io.pixelplex.mobile.cryptoapi.model.common", "ErrorResponse")
    ...
    companion object {
        ...
        private const val CORE_PACKAGE = "io.pixelplex.mobile.cryptoapi.core"
