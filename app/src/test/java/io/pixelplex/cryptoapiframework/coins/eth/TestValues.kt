package io.pixelplex.cryptoapiframework.coins.eth
...
object TestValues {
    ...
    val estimatedGas = EthEstimatedGasCall(
        from = ETH_ADDRESS_1,
        to = ETH_ADDRESS_2,
        value = "10"
    )

    val badEstimatedGas = EthEstimatedGasCall(
        from = "0x141d59",
        to = ETH_ADDRESS_2,
        value = "10"
    )
    ...
    val ethTransfer = EthTransferCall(
    ...
    val badEthTransfer = EthTransferCall(
    ...
    val ethTransaction = EthTransactionCall(
        from = ETH_ADDRESS_1,
        to = ETH_ADDRESS_2,
        skip = 0,
        limit = 3
    ...
    val badEthTransaction = EthTransactionCall(
        from = "0x141d5937C7b",
        to = ETH_ADDRESS_2,
        skip = 0,
        limit = 3
    ...
    val contractCallBody = EthContractCall(
