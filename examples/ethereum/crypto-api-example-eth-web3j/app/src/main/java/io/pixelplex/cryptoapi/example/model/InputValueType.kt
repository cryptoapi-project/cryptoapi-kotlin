...
import io.pixelplex.cryptoapi.example.models.AccountAddressInputValueType.Companion
...
class AddressInputValueType : InputValueType {
    ...
    override fun encode(source: String): String = when {
        ...
        source.startsWith(Companion.PREFIX) -> {
        ...
        source.startsWith(ContractAddressInputValueType.PREFIX) -> {
            ...
            throw Exception("Unable to determine address type for value: $source")
        }
    }
